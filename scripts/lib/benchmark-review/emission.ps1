...
function New-BenchmarkReviewRunManifestArtifacts {
  ...
  return @(
    ...
    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedIndexedComparisonSummary `
      -Path $Context.CurrentTypedIndexedComparisonSummaryCsv `
      -Skipped $false

    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedIndexedComparisonNotes `
      -Path $Context.CurrentTypedIndexedComparisonSummaryNotes `
      -Skipped $false
    ...
    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedArchiveAppendDeltaQuerySummary `
      -Path $Context.CurrentTypedArchiveAppendDeltaQuerySummaryCsv `
      -Skipped $false

    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedArchiveAppendDeltaQueryNotes `
      -Path $Context.CurrentTypedArchiveAppendDeltaQuerySummaryNotes `
      -Skipped $false
    ...
    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedArchiveMaintenanceSummary `
      -Path $Context.CurrentTypedArchiveMaintenanceSummaryCsv `
      -Skipped $false

    New-BenchmarkReviewManifestArtifact `
      -Name $BenchmarkReviewArtifactNames.TypedArchiveMaintenanceNotes `
      -Path $Context.CurrentTypedArchiveMaintenanceSummaryNotes `
      -Skipped $false
