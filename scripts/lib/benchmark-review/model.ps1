...
Set-Variable -Name BenchmarkReviewArtifactNames -Value ([ordered]@{
    ...
    TypedIndexedComparisonSummary             = "typed indexed comparison summary"
    TypedIndexedComparisonNotes               = "typed indexed comparison notes"
    ...
    TypedArchiveAppendDeltaQuerySummary       = "typed archive append-delta query summary"
    TypedArchiveAppendDeltaQueryNotes         = "typed archive append-delta query notes"
...
function New-BenchmarkReviewPathSet {
  ...
  return [PSCustomObject]@{
    ...
    CurrentTypedIndexedComparisonSummaryCsv               = Join-Path $OutputDir "typed-indexed-comparison-summary-$Label.csv"
    CurrentTypedIndexedComparisonSummaryNotes             = Join-Path $OutputDir "typed-indexed-comparison-summary-$Label.txt"
    ...
    CurrentTypedArchiveAppendDeltaQuerySummaryCsv         = Join-Path $OutputDir "typed-archive-append-delta-query-summary-$Label.csv"
    CurrentTypedArchiveAppendDeltaQuerySummaryNotes       = Join-Path $OutputDir "typed-archive-append-delta-query-summary-$Label.txt"
