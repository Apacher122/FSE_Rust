...
function Resolve-BenchmarkReviewManifestArtifactSet {
  ...
  $ResolvedArtifacts.TypedArchiveAppendDeltaQuerySummary = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveAppendDeltaQuerySummary `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath

  $ResolvedArtifacts.TypedArchiveAppendDeltaQueryNotes = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveAppendDeltaQueryNotes `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath

  $ResolvedArtifacts.TypedArchiveCompactionSummary = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveCompactionSummary `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath

  $ResolvedArtifacts.TypedArchiveCompactionNotes = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveCompactionNotes `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath

  $ResolvedArtifacts.TypedArchiveMaintenanceSummary = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveMaintenanceSummary `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath

  $ResolvedArtifacts.TypedArchiveMaintenanceNotes = Resolve-BenchmarkReviewManifestArtifact `
    -Entries $Entries `
    -ArtifactName $BenchmarkReviewArtifactNames.TypedArchiveMaintenanceNotes `
    -OutputDir $OutputDir `
    -Label $Label `
    -OnFailure $OnFailure `
    -OnInvalidPath $OnInvalidPath
