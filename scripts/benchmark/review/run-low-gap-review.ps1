...
if ($UpdateHistory) {
  ...
  Add-ReviewLine "typed archive compaction history: $(Join-Path $HistoryDir "typed-archive-compaction-history.csv")"
  Add-ReviewLine "typed archive maintenance history: $(Join-Path $HistoryDir "typed-archive-maintenance-history.csv")"
  Add-ReviewLine "typed archive append-delta maintenance history: $(Join-Path $HistoryDir "typed-archive-append-delta-maintenance-history.csv")"
