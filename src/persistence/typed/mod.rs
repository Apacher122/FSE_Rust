...
pub use query_index::{
    ...
    FSETypedQueryIndexArchiveMaintenanceResult, FSETypedQueryIndexArchiveMaintenanceStatus,
    FSETypedQueryIndexArchiveSectionFootprint, FSETypedQueryIndexArchiveSnapshot,
