...
pub use footprint::{
    ...
    FSETypedQueryIndexArchiveFootprintError, FSETypedQueryIndexArchiveSectionFootprint,
...
pub use maintenance::{
    ...
    FSETypedQueryIndexArchiveMaintenanceStatus, inspect_typed_query_index_archive_file_maintenance,
