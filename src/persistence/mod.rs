...
pub use typed::{
    ...
    append_typed_row_tombstone_archive_file, decode_typed_query_index_archive_snapshot,
    ...
    read_typed_record_batch_archive_snapshot_file, read_typed_row_tombstone_archive_snapshot_file,
