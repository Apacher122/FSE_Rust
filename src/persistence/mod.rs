...
pub use typed::{
    ...
    FSERecordBatchArchiveSnapshot, FSETypedQueryIndexArchiveAppendResult,
    ...
    FSETypedRecordBatchArchiveSnapshotError, FSETypedRowTombstoneArchiveCodecError,
    ...
    append_typed_record_batch_archive_file, decode_typed_query_index_archive_snapshot,
