...
pub use typed::{
    ...
    FSETypedQueryIndexArchiveFootprintError, FSETypedQueryIndexArchiveLoadResult,
    FSETypedQueryIndexArchiveMaintenanceError, FSETypedQueryIndexArchiveMaintenanceResult,
    FSETypedQueryIndexArchiveMaintenanceStatus, FSETypedQueryIndexArchiveSectionFootprint,
    ...
    FSEValueArchiveRecord, append_typed_query_index_archive_file,
    ...
    typed_query_index_archive_file_section_footprint, typed_query_index_archive_footprint,
    typed_query_index_archive_section_footprint,
