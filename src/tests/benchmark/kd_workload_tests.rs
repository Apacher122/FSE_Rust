use crate::benchmark::{
    KdTreeBaseline, clustered_points_2d, clustered_workload_cases, large_clustered_points_2d,
...
fn kd_tree_matches_flat_scan_for_small_clustered_workloads() {
    ...
    for workload in workloads {
        assert_baseline_matches_flat_scan(KdTreeBaseline::new(&points), &points, &workload.query);
    }
}
...
fn kd_tree_matches_flat_scan_for_boundary_touching_query() {
    ...
    assert_baseline_matches_flat_scan(KdTreeBaseline::new(&points), &points, &query);
}
