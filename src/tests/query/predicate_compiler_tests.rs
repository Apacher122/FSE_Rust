...
fn numeric_predicate_compiler_compiles_integer_equality() {
    ...
    assert_eq!(region.min, vec![42.0, Scalar::MIN, Scalar::MIN]);
    assert_eq!(region.max, vec![42.0, Scalar::MAX, Scalar::MAX]);
}
...
fn numeric_predicate_compiler_compiles_float_range() {
    ...
    assert_eq!(region.min, vec![Scalar::MIN, 41.0, Scalar::MIN]);
    assert_eq!(region.max, vec![Scalar::MAX, 42.0, Scalar::MAX]);
}
...
fn numeric_predicate_compiler_compiles_timestamp_range() {
    ...
    assert_eq!(region.min[2], 1_735_689_600_000_i64 as Scalar);
    assert_eq!(region.max[2], 1_735_689_700_000_i64 as Scalar);
}
