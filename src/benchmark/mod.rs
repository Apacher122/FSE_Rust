...
pub use reports::{
    ...
    PruningEfficiencyReport, QueryComparisonReport, WorkloadComparisonSummary,
    aggregate_workload_metrics, compare_points_lexicographically, compare_query_execution,
    ...
    summarize_workload_comparisons, write_benchmark_csv_outputs,
