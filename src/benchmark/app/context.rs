...
use crate::build::{
    BuildValidationError, FSEBuilder, IndexValidationReport, index_footprint_byte_estimates,
    index_footprint_comparison_metrics, index_footprint_metrics, index_structure_metrics,
};
...
impl BenchmarkApplicationContext {
    ...
    pub fn overview(&self) -> BenchmarkRunOverview {
        BenchmarkRunOverview {
            ...
            index_footprint_byte_estimates: index_footprint_byte_estimates(&self.index),
            index_footprint_comparison: index_footprint_comparison_metrics(&self.index),
