...
pub use comparison::{
    ...
    TypedArchiveAppendDeltaQueryTimingReport, TypedArchiveAppendRebuildTimingReport,
    TypedArchiveCompactionTimingReport, TypedArchiveLoadTimingError, TypedArchiveLoadTimingReport,
    TypedArchiveMaintenanceTimingReport, TypedQueryComparisonReport,
    TypedQueryExistenceComparisonReport, compare_query_execution, compare_query_execution_repeated,
