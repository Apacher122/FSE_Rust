...
pub use typed::{
    ...
    IndexedTypedQueryRowReport, PlannedTypedQueryCountReport, PlannedTypedQueryExistenceReport,
    PlannedTypedQueryRowIdReport, PlannedTypedQueryRowReport, PlannedTypedQueryVisitReport,
    TypedAppendDeltaQueryView, TypedQueryExecutionStrategy, TypedQueryIndex,
    TypedQueryIndexAppendError, TypedQueryIndexBuildError, TypedQueryOutputContract,
    TypedQueryPlan, TypedQueryPlanBuilder, TypedQueryPlanError,
    TypedQueryPlanningCostClassification, TypedQueryPlanningCostComparison,
    TypedQueryPlanningDiagnostics, TypedQueryPlanningReason, TypedQueryPlanningRiskFlags,
    TypedQueryPlanningWorkEstimate, TypedQueryResultRow, TypedQuerySelectivityBucket,
    TypedQueryStrategyCostEstimates, TypedRowTombstoneSet, TypedTombstonedAppendDeltaQueryView,
    TypedTombstonedQueryIndexView, ValidatedFSEPredicate, ValidatedFSEPredicateOperator,
    ...
    planned_typed_query_visit_rows_excluding_tombstones, typed_query_has_match,
