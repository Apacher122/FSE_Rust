...
pub use typed::{
    ...
    PlannedTypedQueryRowIdReport, TypedAppendDeltaQueryView, TypedQueryExecutionStrategy,
    TypedQueryIndex, TypedQueryIndexAppendError, TypedQueryIndexBuildError,
    TypedQueryOutputContract, TypedQueryPlan, TypedQueryPlanBuilder, TypedQueryPlanError,
    TypedQueryPlanningDiagnostics, TypedQueryPlanningReason, TypedQueryResultRow,
    TypedRowTombstoneSet, ValidatedFSEPredicate, ValidatedFSEPredicateOperator,
    ...
    planned_typed_query_has_match, planned_typed_query_row_ids, typed_query_has_match,
