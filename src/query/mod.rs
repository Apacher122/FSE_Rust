...
pub use typed::{
    ...
    TypedQueryPlan, TypedQueryPlanBuilder, TypedQueryPlanError, TypedQueryPlanningDiagnostics,
    TypedQueryPlanningReason, TypedQueryResultRow, TypedRowTombstoneSet, ValidatedFSEPredicate,
    ...
    planned_typed_query_rows, planned_typed_query_visit_row_ids, planned_typed_query_visit_rows,
    typed_query_has_match, visit_indexed_typed_query_row_ids,
    visit_indexed_typed_query_row_ids_excluding_tombstones, visit_indexed_typed_query_rows,
