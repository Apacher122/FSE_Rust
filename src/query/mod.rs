...
pub use typed::{
    ...
    TypedQueryResultRow, TypedQuerySelectivityBucket, TypedRowTombstoneSet,
    TypedTombstonedAppendDeltaQueryView, TypedTombstonedQueryIndexView, ValidatedFSEPredicate,
