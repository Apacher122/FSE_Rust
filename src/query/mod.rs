...
pub use typed::{
    ...
    TypedQueryResultRow, TypedQuerySelectivityBucket, TypedQueryStrategyCostEstimates,
    TypedRowTombstoneSet, TypedTombstonedAppendDeltaQueryView, TypedTombstonedQueryIndexView,
