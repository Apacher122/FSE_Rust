...
pub use typed::{
    ...
    IndexedTypedQueryRowReport, TypedAppendDeltaQueryView, TypedQueryExecutionStrategy,
    ...
    plan_typed_append_delta_query_execution, plan_typed_query_execution, typed_query_has_match,
