...
pub use typed::{
    ...
    PlannedTypedQueryRowIdReport, PlannedTypedQueryRowReport, TypedAppendDeltaQueryView,
    ...
    planned_typed_query_rows, typed_query_has_match, visit_indexed_typed_query_row_ids,
